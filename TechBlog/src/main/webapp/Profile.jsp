<%@page import="com.tech.blog.entities.Category"%> <%@page
import="java.util.ArrayList"%> <%@page
import="com.tech.blog.helper.ConnectionProvider"%> <%@page
import="com.tech.blog.dao.PostDao"%> <%@page
import="com.tech.blog.entities.User"%> <%@page
import="com.tech.blog.entities.Message"%> <%@ page language="java"
contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<!DOCTYPE html>

<%@ page errorPage="errorPage.jsp"%> <% User loggedInUser = (User)
session.getAttribute("currentUser"); if (loggedInUser == null) {
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark primary-background">
      <a class="navbar-brand" href="/TechBlog">
        <span class="fa fa-comments"></span> Tech Blog
      </a>
      <button
        ...
        <ul class="navbar-nav mr-right">
          <li>
            <a class="nav-link" data-toggle="modal" data-target="#exampleModal">
              <span class="fa fa-user"></span> <%=loggedInUser.getName()%>
            </a>
          </li>
          <li>
        ...
        <div class="row mt-4">
          <div class="col-md-4">
            <div class="list-group">
              <a href="#" onclick="getPosts(<%= 0 %>, this)" class="catLink allPosts list-group-item list-group-item-action active">
                All categories
              </a>
			  <% PostDao pd1 = new PostDao(ConnectionProvider.getCon());
			  ArrayList<Category> categories1 = pd1.getAllCategories();
				  for (Category c : categories1) { %>
					<a href="#" onclick="getPosts(<%= c.getCid() %>, this)" class="catLink list-group-item list-group-item-action"
					  ><%=c.getName()%></a
					>
                  <% } %>
            </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          name="userPassword"
                          class="form-control"
                          value="<%=loggedInUser.getPassword()%>"
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <textarea
                          ...
                          rows="3"
                        >
<%=loggedInUser.getAbout()%></textarea
                        >
                      </td>
                    </tr>
                    <tr>
            ...
            <form id="addPostForm" action="AddPost" method="post">
              ...
              <div class="form-group">
                <textarea
                  ...
                  class="form-control"
                  cols="5"
                  placeholder="Enter your code here (if any)"
                ></textarea>
              </div>
              <div class="form-group">
